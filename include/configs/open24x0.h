...
#define MTDPARTS_DEFAULT "mtdparts=nandflash0:256k@0(supervivi)," \
	                        "128k(params)," \
	                        "5m(kernel)," \ 
                            "250m(root)," \
                            "-(nand)"
...
#define	CFG_PROMPT		"FA24x0> "	/* Monitor Command Prompt	*/
...
#define CFG_ENV_ADDR		(CFG_FLASH_BASE + 0x060000) /* addr of environment */
#endif
